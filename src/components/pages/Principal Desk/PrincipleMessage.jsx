  ...
  return (
    <div className="p-0 container-fluid">
      <div className="main-container mt-5">
        ...
        <h2 className='text-center mt-5 fs-1 fw-bold'><span className='head-frist mt-5'>Suchitra</span><span className='mt-5'>Bendre</span> </h2>
          <p><b>WELCOME!!</b></p>
      ...
      <div className='For_Background_Image'>
        ...
        <div className="imagefix1"><h1 className='fw-bolder'>Tell Us What Are You Looking For</h1>
