            ...
            <div className="why-hero-section">
                <div className="row justify-content-center">
                    <div className="col-md-12">
                        <div className="col-md-6 d-flex flex-column justify-content-center" style={{ color: 'white', marginTop: '10%' }}>
                            <div className='typewriter' style={{ fontSize: "2rem" }}>
                                <Typewriter
                                    options={{
                                        strings: ["Why Super School?"],
                                        autoStart: true,
                                        loop: true,
            ...
            <div className="container">
                <div className="row justify-content-center mt-4">
                    <div className="col-md-4 mb-4">
                        <div className="card why-card student-card">
